...
extern osSemaphoreId_t sem_mem_writeHandle;
extern osSemaphoreId_t sem_mem_readHandle;
extern SPI_HandleTypeDef hspi1;

#define sem_SPI_rx	sem_mem_readHandle
#define sem_SPI_tx	sem_mem_writeHandle

#define USE_SPI
#define SPI_INSTANCE	hspi1

#define M95P32_EEPROM_SPI_CS_PIN 	SPI1_CS_Pin
#define M95P32_EEPROM_SPI_CS_PORT	SPI1_CS_GPIO_Port
